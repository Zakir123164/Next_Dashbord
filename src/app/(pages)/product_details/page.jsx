...
const Page = () => {
  ...
  return (
    <div className="min-h-screen flex justify-center items-start py-6">
      ...
      <div className="w-full bg-white border-b border-gray-200 flex items-start">
        {/* ========== SIDEBAR ========== */}
        <aside className="w-[256px] mt-[-25px] bg-sky-300 border-r border-[#E8EDF2] flex flex-col">
          {/* Main nav */}
